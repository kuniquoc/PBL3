  ...
  public class DestinationController : Controller
  {
    ...
    public IActionResult UpdateFavDes([FromBody] FavoriteModel favorite)
    {
      try
      {
        ...
        return StatusCode(200, new { message = "Destination favorite status updated" });
      }
      catch (Exception e)
      {
        Console.WriteLine(e.Message);
        return StatusCode(500, new { message = "Something wrong happened. Please try again later." });
      }
    }
