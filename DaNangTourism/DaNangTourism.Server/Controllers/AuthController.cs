    ...
    public class AuthController(IConfiguration configuration) : Controller
    {
        ...
        */
        ...
        public ActionResult Login([FromBody] AccountLoginModel account)
        {
            ...
            _ = _accountBLL.GenerateJwtToken(accountDB, Response);
        ...
        */
        ...
        public ActionResult Logout()
        {
            ...
            {
                Path = "/", // Đảm bảo rằng cookie được xóa trên tất cả các đường dẫn
                HttpOnly = true, // Đảm bảo rằng cookie không thể truy cập được thông qua mã JavaScript
                SameSite = SameSiteMode.Strict, // Ngăn chặn các yêu cầu từ các trang web khác mà không có ghi danh
                Expires = DateTime.Now.AddDays(-1) // Thiết lập thời gian hết hiệu lực của cookie
            });
        ...
        */
        ...
        public ActionResult ChangePassword([FromBody] AccountChangePasswordModel account)
        {
            ...
            catch (Exception ex)
            {
                ...
                return Unauthorized($"Change password failed: {ex.Message}");
            }
        }
