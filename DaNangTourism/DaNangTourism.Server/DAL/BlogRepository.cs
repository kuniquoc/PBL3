...
namespace DaNangTourism.Server.DAL
{
  ...
  public class BlogRepository : IBlogRepository
  {
    ...
    {
      string sql = "SELECT blog_id, type, title, image, full_name AS author, " +
          "blogs.created_at FROM blogs LEFT JOIN Users ON Users.user_id = blogs.user_id " +
    ...
    public int AddBlog(BlogAdd blogAdd, int uid)
    {
      ...
      MySqlParameter[] parameters =
      {
          ...
          new ("@type", blogAdd.type.ToString()),
